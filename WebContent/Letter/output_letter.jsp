...
<body>
	...
	<table id="info" name="info" width="100%" border="0">
		<tr>
			<td style="width: 70%; 	font-family: 'Noto Serif KR', sans-serif;"><b><%=letter.getSenderId()%>님이 보낸 쪽지입니다.</b></td>
			...
			<td width="8%">
				<div class="golist">
					<input type="button" value="목록" class="btn btn-primary"
						onclick="location.href='letter_recieve_list.jsp'">
				</div>
			</td>
			<td width="84%">
			<td width="8%">
				<div class="delete">
					<input type="button" value="삭제하기" class="btn btn-secondary"
						onclick="location.href='db_delete_recieve_letter.jsp?letterId=<%=letterId%>'">
				</div>
			</td>
		</tr>
	</table>
