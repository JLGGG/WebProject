	...
	<div style="position: center">
		<center>
			<div id="header">
				...
				%>
				<iframe src="notLoginHeader.html" width="100%" height="auto" scrolling="no"
					style="z-index: 20"></iframe>
				<%
					} else {						//로그인이 되어있을때,
				%>
				<iframe src="loginHeader.jsp" width="100%" height="auto" scrolling="no"
					style="z-index: 20"></iframe>
				<%
					}
				%>
