...
<body>
	...
	<p align="right">
		<font align="right" color="orange">이름순</font> <a
			href="dad_list_recent.jsp" style="text-decoration: none">최신순</a> <a
			href="dad_list_views.jsp" style="text-decoration: none">조회수순</a>
	</p>
	<table class="NS" width="100%" cellpadding="3" cellspacing="0" border="0">
		...
		<tbody>
			<%
				...
				ArrayList<Board> list = boardDAO.getListBYname();
	...
	<center><br>
		...
		if (pageNumber != 1) {
	%>
	<a href="dad_list_name.jsp?pageNumber=<%=pageNumber - 1%>">이전</a>
	<%
		}
		if (boardDAO.nextPage(pageNumber - max_page)) {
	%>

	<a href="dad_list_name.jsp?pageNumber=<%=pageNumber + 1%>">다음</a>
	<%
		}
	%></font>
	</center>
