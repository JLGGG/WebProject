...
<title>아빠 게시판 목록 조회수순 페이지</title>
<style type="text/css">
...
<body>
	...
	<p align="right">
		...
		<a href="dad_list_recent.jsp" style="text-decoration: none">최신순</a>
	...
	<center><br>
		...
		if (pageNumber != 1) {
	%>
	<a href="dad_list_views.jsp?pageNumber=<%=pageNumber - 1%>">이전</a>
	<%
		}
		if (boardDAO.nextPage(pageNumber - max_page)) {
	%>

	<a href="dad_list_views.jsp?pageNumber=<%=pageNumber + 1%>">다음</a>
	<%
		}
	%></font>
	</center>
