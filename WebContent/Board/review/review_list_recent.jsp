...
<body>
	...
	<table class="NS" width="100%" cellpadding="3" cellspacing="0" border="0">
		<thead>
			<tr style="text-align: center; "><th width="10%">번호</th>
				<th width="35%">제목</th>
				<th width="15%">작성자</th>
				<th width="20%">작성일</th>
				<th width="10%">조회수</th>
	...
	<center><br>
		...
		if (pageNumber != 1) {
	%>
	<a href="review_list_recent.jsp?pageNumber=<%=pageNumber - 1%>">이전</a>
	<%
		}
		if (boardDAO.nextPage(pageNumber - max_page)) {
	%>

	<a href="review_list_recent.jsp?pageNumber=<%=pageNumber + 1%>">다음</a>
	<%
		}
	%></font>
	</center>
