...
<body>
	...
	<p align="right">
		<font align="right" color="orange">이름순</font> 
		<a href="review_list_recent.jsp" style="text-decoration: none">최신순</a> 
		<a href="review_list_views.jsp" style="text-decoration: none">조회수순</a>
	</p>
	...
	<center><br>
		...
		if (pageNumber != 1) {
	%>
	<a href="review_list_name.jsp?pageNumber=<%=pageNumber - 1%>">이전</a>
	<%
		}
		if (boardDAO.nextPage(pageNumber - max_page)) {
	%>

	<a href="review_list_name.jsp?pageNumber=<%=pageNumber + 1%>">다음</a>
	<%
		}
	%></font>
	</center>
