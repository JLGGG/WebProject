...
<title>엄마 게시판 목록 조회수순 페이지</title>
...
<body>
	...
	<p align="right">
		<a href="mom_list_name.jsp" style="text-decoration: none">이름순</a> <a
			href="mom_list_recent.jsp" style="text-decoration: none">최신순</a> <font
			align="right" color="orange">조회수순</font>
	</p>
	...
	<table width="100%" cellpadding="3" cellspacing="0" border="0">
		...
		<tr style="text-align: center;">
			<td><%=i + 1%></td>
			<td><a	href="output_mom_Write.jsp?postId=<%=list.get(i).getPostId()%>">
					<%=list.get(i).getTitle()%>
			</a></td>
	...
	<br>
		<font size="2" > <%
 	if (pageNumber != 1) {
 %> <a href="mom_list_views.jsp?pageNumber=<%=pageNumber - 1%>">이전</a> <%
 	}
 	if (boardDAO.nextPage(pageNumber - max_page)) {
 %> <a href="mom_list_views.jsp?pageNumber=<%=pageNumber + 1%>">다음</a> <%
 	}
 %></font>
	</center>
