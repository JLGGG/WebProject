...
<body>
	...
	<br>
	<p align="right">
		<font align="right" color="orange">이름순</font> <a
			href="mom_list_recent.jsp" style="text-decoration: none">최신순</a> <a
			href="mom_list_views.jsp" style="text-decoration: none">조회수순</a>
	</p>
	<table>
		<thead>
		...
		<tbody>
			<%
				...
				ArrayList<Board> list = boardDAO.getListBYtitle();
			...
			<tr style="text-align: center;">
				<td><%=i + 1%></td>
				<td><a
					href="output_mom_Write.jsp?postId=<%=list.get(i).getPostId()%>">
						<%=list.get(i).getTitle()%>
				</a></td>
	...
	<font size="2">
			<%
				if (pageNumber != 1) {
			%> <a href="mom_list_name.jsp?pageNumber=<%=pageNumber - 1%>">이전</a> <%
 	}
 	if (boardDAO.nextPage(pageNumber - max_page)) {
 %> <a href="mom_list_name.jsp?pageNumber=<%=pageNumber + 1%>">다음</a> <%
 	}
 %>	</font>
	</center>
	...
	<br><br>
	<div class="right">
		<input class="myButton" type="button" value="글쓰기"	onclick="location.href='input_mom_Write.jsp'">
	</div>
</body>
</html>