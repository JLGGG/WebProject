...
<body>
	...
	<br>
	<p align="right">
		<a href="mom_list_name.jsp" style="text-decoration: none">이름순</a> <font
			align="right" color="orange">최신순</font> <a href="mom_list_views.jsp"
			style="text-decoration: none">조회수순</a>
	</p>
	...
	<center><br>
		<font size="2"> <%
 	if (pageNumber != 1) {
 %> <a href="mom_list_recent.jsp?pageNumber=<%=pageNumber - 1%>">이전</a>
			<%
				}
				if (boardDAO.nextPage(pageNumber-max_page)) {
			%> <a href="mom_list_recent.jsp?pageNumber=<%=pageNumber + 1%>">다음</a>
			<%
				}
			%>
		</font>
